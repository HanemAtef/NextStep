...
//   const { data: request, loading, error } = useSelector((state) => state.details);
//   const { loading: downloadLoading } = useSelector((state) => state.download);

//   const handleDownload = () => {
//     if (id) {
//       dispatch(downloadApplicationFile({ id }));
//     }
//   };
