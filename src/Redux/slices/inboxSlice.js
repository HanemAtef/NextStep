...
const APPLICATION_TYPE_MAPPING = {
    ...
    'طلب الالتحاق الخاص بقسم الحسابات العلمية': 3,
    ...
    'ايقاف قيد الخاص بقسم علوم الحاسب': 9,
    'ايقاف قيد الخاص بقسم نظم المعلومات': 10,
    'ايقاف قيد الخاص بقسم الحسابات العلمية': 11,
    ...
    'الغاء تسجيل الخاص بقسم ذكاء اصطناعي': 115,
    'سيمنار 1 تعيين لجنة الاشراف والخطة البحثية الخاص بقسم علوم الحاسب': 17,
    'سيمنار 1 تعيين لجنة الاشراف والخطة البحثية الخاص بقسم نظم المعلومات': 18,
    'سيمنار 1 تعيين لجنة الاشراف والخطة البحثية الخاص بقسم الحسابات العلمية': 19,
    'سيمنار 1 تعيين لجنة الاشراف والخطة البحثية الخاص بقسم ذكاء اصطناعي': 20,
    'سيمنار 2 صلاحية الخاص بقسم علوم الحاسب': 21,
    'سيمنار 2 صلاحية الخاص بقسم نظم المعلومات': 22,
    'سيمنار 2 صلاحية الخاص بقسم الحسابات العلمية': 23,
    'سيمنار 2 صلاحية الخاص بقسم ذكاء اصطناعي': 24,
    'تشكيل لجنة الحكم والمناقشة الخاص بقسم علوم الحاسب': 117,
    'تشكيل لجنة الحكم والمناقشة الخاص بقسم نظم المعلومات': 118,
    'تشكيل لجنة الحكم والمناقشة الخاص بقسم ذكاء اصطناعي': 119,
    'تشكيل لجنة الحكم والمناقشة الخاص بقسم الحسابات العلمية': 120,
    'سيمنار مناقشة الخاص بقسم علوم الحاسب': 29,
    'سيمنار مناقشة الخاص بقسم نظم المعلومات': 30,
    'سيمنار مناقشة الخاص بقسم الحسابات العلمية': 31,
    'سيمنار مناقشة الخاص بقسم ذكاء اصطناعي': 32,
    'منح الخاص بقسم علوم الحاسب': 33,
    'منح الخاص بقسم نظم المعلومات': 34,
    'منح الخاص بقسم الحسابات العلمية': 35,
